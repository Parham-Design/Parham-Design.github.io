...
let pageText = {
  ...
  persian: [
    ...
    {
      elementId: "sidenav_home_link",
      text: "خانه<i class='bx bxs-home'></i>",
    },
    {
      elementId: "sidenav_about_link",
      text: "درباره<i class='bx bxs-info-circle'></i>",
    },
    {
      elementId: "sidenav_services_link",
      text: "خدمات<i class='bx bxs-offer'></i>",
    },
    {
      elementId: "sidenav_works_link",
      text: "پروژه ها<i class='bx bxs-briefcase'></i>",
    },
    {
      elementId: "sidenav_contact_link",
      text: "تماس با ما<i class='bx bxs-contact'></i>",
    },
    {
      elementId: "hero_section_heding_h3",
      text: "سلام!",
    ...
    },
    {
      elementId: "hero_section_paragraph",
      text: `
        من از سال 2019 به عنوان یک طراح وب و توسعه دهنده فرانتند مشغول به کار بودم.
         من همیشه با بهره گیری از خلاقیت در کنار مهارت هایی که دارم سعی می کنم بهترینم رو اراعه بدم.
      `,
    },
    {
      elementId: "hero_section_button",
      text: "دانلود رزومه<i class='material-icons'> download </i>",
    },
    {
      elementId: "about_section_heding_h2",
      text: "درباره <span>من</span>",
    },
    {
      elementId: "about_section_heding_h3",
      text: "طراح وب و توسعه دهنده فرانتند",
    },
    {
      elementId: "about_section_paragraph_first",
      text: `
      من سهیل زرین پور هستم، خیلی ها مرا با نام پرهام می شناسند. من یک توسعه دهنده وب، طراح رابط کاربری / طراح تجربه کاربری هستم. من تجربه زیادی در کار با Html5 CSS3 SCSS jQuery و Javascript دارم. من همچنین با برخی از فریمورک ها مانند Angular و Vue js کار کردم. من در کار با Materialize CSS و Bootstrap CSS مسلط هستم. گاهی اوقات وب سایت هایم را با PHP یا Node Js توسعه می دهم و البته از MySQL برای پایگاه داده استفاده می کنم.
      `,
    },
    {
      elementId: "about_section_paragraph_second",
      text: `
      خوب، ممکن است بپرسید چه اتفاقی باعث شد که من برنامه نویس شوم. خوب، من در وهله اول شروع به یادگیری در مورد تعمیرات کامپیوتر کردم، اما بعد از گذشت چند سال به سمت نرم افزار رفتم. برادران من هر دو برنامه نویس هستند و به آرامی مرا نیز به سمت برنامه نویسی سوق دادند. و اکنون، پس از مدت زیادی آموزش وتمرین در زمینه برنامه نویسی فرانتند مانند آنچه قبلا ذکر کردم، من یک برنامه نویس وب شدم.
      `,
    },
    {
      elementId: "about_section_button",
    ...
    {
      elementId: "services_section_heding_h2",
      text: "خدمات <span>من</span>",
    },
    {
      elementId: "services_section_box_heding_1",
      text: "برنامه نویسی تحت وب",
    },
    {
      elementId: "services_section_box_paragraph_1",
      text: `
      پیاده سازی طرح ها با بالاترین کیفیت در کمترین زمان ممکن برای وبسایت ها و وب اپلیکیشن های مختلف
      `,
    },
    {
      elementId: "services_section_box_button_1",
    ...
    {
      elementId: "services_section_box_heding_2",
      text: "طراحی واکنش گرا",
    },
    {
      elementId: "services_section_box_paragraph_2",
      text: `
      پیاده سازی طرح ها به طور کاملا ریسپانسیو و واکنش پذیر برای استفاده در انواع دسنگاه های مختلف با اندازه صفحه نمایش های متفاوت 
      `,
    },
    {
      elementId: "services_section_box_button_2",
    ...
    },
    {
      elementId: "services_section_box_paragraph_3",
      text: `
      طراحی صفحات و تم ها مختلف و اپلیکیشن ها مطابق با جدید ترین استاندارد های طراحی و دیزاین با در نظر گرفتن نیاز های کاربران
      `,
    },
    {
      elementId: "services_section_box_button_3",
    ...
    {
      elementId: "works_section_paragraph_box_1",
      text: "به زودی می توانید در این قسمت آخرین و بروز ترین پروژه هامو ببینید",
    },
    {
      elementId: "works_section_heding_box_2",
      text: "طراحی 2",
